...
excerpt: Uncovering the formation and evolution of gas giant planets using direct-imaging techniques.<br/><img src="/images/accretion_art.jpg" width=600 style='vertical-align:bottom;margin:5px 5px;display:block'>
...
<figure>
  <img src="/images/PDS70_HST.png" alt="An illustration of an accretion planet." width="1000">
  <figcaption>Background picture: an artistic illustration of a protoplanet growing through magnetospheric accretion. Inserted image in the upper right: the HST/WFC3 detection of PDS 70 b in ultraviolet and H-alpha.</figcaption>
</figure>
...
<figure>
  <img src="/images/ABAurb_HST.png" alt="The multi-band images of proplanetary disk around AB Aur." width="1000">
  <figcaption>HST high-contrast imaging observations yield spectacular images of protoplanets and their natal disks. The multi-wavelength observations enable accurate identification of forming planets.</figcaption>
</figure>

I am a leader in high-contrast imaging observations of exoplanets, in particular, with space-based observatories. My team and I achieved a significant milestone by observing the PDS 70 using the Hubble Space Telescope (HST) (Zhou et al. [2021](https://ui.adsabs.harvard.edu/abs/2021AJ....161..244Z/abstract)). The direct measurement of planet PDS 70 b's mass accretion rate through ultraviolet and H-alpha imaging showcased the HST's remarkable high-contrast imaging capabilities. Currently, I lead the HST Cycle 30 program HALPHA: Hubble Accreting Luminous Protoplanets in H-Alpha, further harnessing the imaging power of HST for protoplanet discovery and characterization (e.g., Zhou et al. [2022](https://ui.adsabs.harvard.edu/abs/2022ApJ...934L..13Z/abstract)). Moreover, in collaboration with Dr. Brendan Bowler's group (Bowler et al. [2021](https://ui.adsabs.harvard.edu/abs/2021ApJ...913L..26B/abstract)), we have been gathering crucial infrared photometry data on the benchmark brown dwarf HD 47127 B using the Keck telescope.`<br/>`

<figure>
  <img src="/images/Disk_HST.png" alt="Protoplanetary disk images observed in the HALPHA survey." width="1000">
  <figcaption>The HALPHA survey has collected narrowband H-alpha images of ten transition disks. These images have already revealed a wealth of substructures in scattered light. A deep dive into these data will result in a tight constraint on the protoplanet population.</figcaption>
</figure>
